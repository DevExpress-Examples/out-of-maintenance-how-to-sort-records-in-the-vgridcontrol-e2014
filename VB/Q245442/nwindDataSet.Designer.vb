...
Namespace Q245442
    ...
    Partial Public Class nwindDataSet
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableCategories = (DirectCast(MyBase.Tables("Categories"), CategoriesDataTable))
        ...
        Partial Public Class CategoriesRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableCategories = (DirectCast(Me.Table, CategoriesDataTable))
            End Sub
    ...
    End Class
End Namespace
Namespace Q245442.nwindDataSetTableAdapters
